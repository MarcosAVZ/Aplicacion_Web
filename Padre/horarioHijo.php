    ...
    <div class="offcanvas offcanvas-start" tabindex="-1" id="offcanvasExample" aria-labelledby="offcanvasExampleLabel">
        ...
        <div class="offcanvas-body">
            ...
            <div class="list-group">
                ...
                ?>
                <a href="horarioHijo.php" class="list-group-item list-group-item-action active" aria-current="true"><i class="bi bi-calendar pe-2" style="color: cornflowerblue;"></i>Horarios</a>
